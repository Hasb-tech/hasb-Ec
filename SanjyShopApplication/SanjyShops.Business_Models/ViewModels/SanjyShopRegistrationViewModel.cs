    ...
    public class SanjyShopRegistrationViewModel : BaseModel
    {
        public SanjyShopRegistrationViewModel()
        {
           ...
           ShopeTypes = new List<SelectListModel>();
            ...
            CountryCodes = new List<SelectListModel>();
       ...
       // [Required(AllowEmptyStrings = false)]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "Country_Code_Required")]
        ...
        [RegularExpression("^([a-zA-Z0-9_\\-\\.]+)@([a-zA-Z0-9_\\-\\.]+)\\.([a-zA-Z]{2,5})$", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "Email_Type")]
        ...
        [RegularExpression("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[^\\da-zA-Z]).{7,15}$", ErrorMessageResourceType = typeof(ModelResources),ErrorMessageResourceName = "Password_Type")]
        ...
        [Compare("Password",  ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "ConfirmPassword_mismatch")]
        ...
        [RegularExpression("\\d{2}[A-Z]{5}\\d{4}[A-Z]{1}[A-Z\\d]{1}[Z]{1}[A-Z\\d]{1}", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "GST_Type")]
        ...
        [RegularExpression("^[0-9]{14}$", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "FSSAI_Type")]
        ...
        [RegularExpression("(^\\d{5}$)|(^\\d{6}$)|(^\\d{6})", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "pincode_Type")]
        ...
        [RegularExpression("^\\d{5,20}$", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "ACC_Type")]
        ...
        [RegularExpression("[A-Z]{5}[0-9]{4}[A-Z]{1}", ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "PAN_Type")]

        public string PAN_Number { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "FSSAICard_Required")]
        public string FSSAI { get; set; }
        //public IEnumerable<HttpPostedFileBase> files { get; set; }
        //public HttpPostedFileBase FSSAI_File { get; set; }
        ...
        [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "PAN_Required")]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(ModelResources), ErrorMessageResourceName = "Passbook_Required")]
        ...
        public List<SelectListModel> CountryCodes { get; set; }
